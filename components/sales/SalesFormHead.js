...
function SalesFormHead({customers, billno, billInfo, sellectDate, sellectCustomer, submitBill}) {
           ...
           <div className='flex justify-between   '>
              ...
              <div className='flex w-9/12 space-x-5  '>
                ...
                <div className='flex w-1/2 flex-col space-y-5'>
                    ...
                    <div className='flex justify-between items-center  w-full  '>
                      <label htmlFor="customer" className='w-28 text-lg text-gray-500 ' >Customer</label>
                      <select name='customer' placeholder='customer' value={billInfo.customer} 
